...
That page is the easiest way to run the season without editing the files by hand.
...
## 9. Player photos
Put headshots in `images/players/`.
Name each file with the player id, like `will-stafford.jpeg`.
The site will try to use those images automatically on player cards, stat tables, and game logs.
